    ...
    if pw_persona == pw:
        ...
        if (verificador == (first_term+second_term)):
            ...
            while(True):
                ...
                if seleccion == 4:
                    if (len(matriz_coordenadas) == 0) or (len(vector_distancias) == 0):
                        print("Error de alistamiento")
                        break
                    else:
                        #diccionario de datos reto 5
                        informacion = {
                            'actual': [str(latitud_referencia), str(longitud_referencia)],
                            'zonawifi1': [str(latitud_minima_uno), str(longitud_minima_uno), cantidad_personas_uno],
                            'recorrido': [str(distancia_minima_uno), "a pie", str(tiempo_promedio_pie)]
                            }
                        print(informacion);
                        ...
                        if eleccion == 0:
                            pass
                        if eleccion != 1 and eleccion != 0:
                            print("Error")
                            break
                if seleccion == 5:
                    with open('index.txt', 'r') as f:
                        matriz_precargada = [[float(num) for num in line.split(',')] for line in f]
                    print(matriz_precargada)
